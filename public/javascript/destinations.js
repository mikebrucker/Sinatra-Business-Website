...
close.addEventListener('click', function() {
    ...
    localStorage.setItem('sydney', false);
    localStorage.setItem('innsbruck', false);
});
...
inquire.addEventListener('click', function() {
    ...
    localStorage.setItem('inquireIsClicked', 'true');
    window.location = '/contact';
});

window.addEventListener("load", function(event) {
    var modalSydney = localStorage.getItem('sydney');
    var modalInnsbruck = localStorage.getItem('innsbruck');
    if (modalSydney == 'true') {
        sydneyshow();
    } else if (modalInnsbruck == 'true') {
        innsbruckshow();
    }
    localStorage.setItem('sydney', 'false');
    localStorage.setItem('innsbruck', 'false'); 

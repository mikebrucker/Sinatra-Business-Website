...
var homeSydney = document.querySelector('#homeSydney');
var homeInnsbruck = document.querySelector('#homeInnsbruck');
...
homeSydney.addEventListener('click', function() {
    localStorage.setItem('sydney', 'true')
    window.location.href = '/destinations';
})

homeInnsbruck.addEventListener('click', function() {
    localStorage.setItem('innsbruck', 'true')
    window.location.href = '/destinations';
})
